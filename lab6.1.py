...
print('apple의 가격은',fruit_dic['apple'],'원입니다')
print('banana의 가격은',fruit_dic['banana'],'원입니다')
print('grape의 가격은',fruit_dic['grape'],'원입니다')
print('melon의 가격은',fruit_dic['melon'],'원입니다')
